...
fig.axs[0][0].set_ylim(10, y_top)
fig.axs[1][0].set_ylim(y_bottom, 4)
...
fig.axs[0][1].set_ylim(0.011, y_top)
fig.axs[1][1].set_ylim(y_bottom, 0.0025)
...
# fig.savefig(os.path.join(fig_dir, "model_compare_all_BPS.svg"),
#             format='svg')
fig.savefig(os.path.join(fig_dir, "model_compare_all.pdf"))
